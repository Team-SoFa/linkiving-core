...
compose() {
    sudo --preserve-env=GRAFANA_ADMIN_USER,GRAFANA_ADMIN_PASSWORD,ANALYTICS_GA4_DEBUG_MODE,APP_MEMBER_WITHDRAWAL_ENABLED,APP_MEMBER_WITHDRAWAL_INTERNAL_SECRET \
