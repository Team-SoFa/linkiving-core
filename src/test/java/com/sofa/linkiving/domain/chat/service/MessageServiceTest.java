...
public class MessageServiceTest {
	...
	void shouldRequestSummariesForDistinctLinks() {
		...
		// then
		// ArgumentCaptor를 사용하여 실제 서비스에 넘어간 리스트 검증 가능
		// 여기서는 간단히 호출 시 리스트 크기로 간접 검증하거나, 로직상 distinct()가 있으므로
		// summaryQueryService가 한 번 호출되었는지만 확인해도 무방하지만,
		// 엄격하게 확인하려면 ArgumentCaptor 사용 권장.
